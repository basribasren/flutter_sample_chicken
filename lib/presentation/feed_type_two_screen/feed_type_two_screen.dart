import 'bloc/feed_type_two_bloc.dart';
import 'models/feed_type_two_model.dart';
...
class FeedTypeTwoScreen extends StatelessWidget {
  const FeedTypeTwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<FeedTypeTwoBloc>(
      create: (context) => FeedTypeTwoBloc(FeedTypeTwoState(
        feedTypeTwoModelObj: FeedTypeTwoModel(),
      ))
        ..add(FeedTypeTwoInitialEvent()),
      child: FeedTypeTwoScreen(),
    );
  }
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: BlocSelector<FeedTypeTwoBloc, FeedTypeTwoState,
                    TextEditingController?>(
                  selector: (state) => state.feedTypeNameController,
                  builder: (context, feedTypeNameController) {
                    return CustomTextFormField(
                      controller: feedTypeNameController,
