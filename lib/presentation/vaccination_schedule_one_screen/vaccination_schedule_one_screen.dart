import 'bloc/vaccination_schedule_one_bloc.dart';
import 'models/vaccination_schedule_one_model.dart';
...
class VaccinationScheduleOneScreen extends StatelessWidget {
  VaccinationScheduleOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<VaccinationScheduleOneBloc>(
      create: (context) =>
          VaccinationScheduleOneBloc(VaccinationScheduleOneState(
        vaccinationScheduleOneModelObj: VaccinationScheduleOneModel(),
      ))
            ..add(VaccinationScheduleOneInitialEvent()),
      child: VaccinationScheduleOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<VaccinationScheduleOneBloc, VaccinationScheduleOneState>(
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: AppbarTitle(
        text: "msg_vaccination_schedule".tr,
        ...
        children: [
          Align(
            ...
            child: Padding(
              ...
              child: Text(
                "msg_no_vaccination_schedule".tr,
            ...
            children: [
              ...
              Opacity(
                ...
                child: Padding(
                  ...
                  child: Text(
                    "msg_below_to_add_vaccination".tr,
                    style: CustomTextStyles.bodyMediumPoppinsBlack900,
                  ),
                ),
              ),
