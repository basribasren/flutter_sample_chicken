import 'bloc/new_eggs_bloc.dart';
import 'models/new_eggs_model.dart';
...
class NewEggsScreen extends StatelessWidget {
  NewEggsScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NewEggsBloc>(
      create: (context) => NewEggsBloc(NewEggsState(
        newEggsModelObj: NewEggsModel(),
      ))
        ..add(NewEggsInitialEvent()),
      child: NewEggsScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<NewEggsBloc, NewEggsState>(
  ...
  /// Section Widget
  Widget _buildNewEggs(BuildContext context) {
    return Container(
