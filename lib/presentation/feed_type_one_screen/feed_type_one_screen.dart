import 'bloc/feed_type_one_bloc.dart';
import 'models/feed_type_one_model.dart';
...
class FeedTypeOneScreen extends StatelessWidget {
  FeedTypeOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<FeedTypeOneBloc>(
      create: (context) => FeedTypeOneBloc(FeedTypeOneState(
        feedTypeOneModelObj: FeedTypeOneModel(),
      ))
        ..add(FeedTypeOneInitialEvent()),
      child: FeedTypeOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<FeedTypeOneBloc, FeedTypeOneState>(
  ...
  /// Section Widget
  Widget _buildFeedTypeOne(BuildContext context) {
    return Column(
      children: [
        Align(
