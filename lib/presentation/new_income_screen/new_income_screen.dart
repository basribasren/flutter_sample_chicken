import 'bloc/new_income_bloc.dart';
import 'models/new_income_model.dart';
...
class NewIncomeScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NewIncomeBloc>(
      create: (context) => NewIncomeBloc(NewIncomeState(
        newIncomeModelObj: NewIncomeModel(),
      ))
        ..add(NewIncomeInitialEvent()),
  ...
  /// Section Widget
  Widget _buildNewIncome(BuildContext context) {
    return Container(
