import 'bloc/new_notes_bloc.dart';
import 'models/new_notes_model.dart';
...
class NewNotesScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NewNotesBloc>(
      create: (context) => NewNotesBloc(NewNotesState(
        newNotesModelObj: NewNotesModel(),
      ))
        ..add(NewNotesInitialEvent()),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<NewNotesBloc, NewNotesState>(
  ...
  /// Section Widget
  Widget _buildNewNotes(BuildContext context) {
    return Column(
      children: [
        Text(
          "lbl_notes".tr,
