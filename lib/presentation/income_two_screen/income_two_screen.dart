import 'bloc/income_two_bloc.dart';
import 'models/income_two_model.dart';
...
class IncomeTwoScreen extends StatelessWidget {
  const IncomeTwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<IncomeTwoBloc>(
      create: (context) => IncomeTwoBloc(IncomeTwoState(
        incomeTwoModelObj: IncomeTwoModel(),
      ))
        ..add(IncomeTwoInitialEvent()),
      child: IncomeTwoScreen(),
    );
  }
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: BlocSelector<IncomeTwoBloc, IncomeTwoState,
