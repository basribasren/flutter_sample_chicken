import 'bloc/new_sub_user_bloc.dart';
import 'models/new_sub_user_model.dart';
...
class NewSubUserScreen extends StatelessWidget {
  NewSubUserScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NewSubUserBloc>(
      create: (context) => NewSubUserBloc(NewSubUserState(
        newSubUserModelObj: NewSubUserModel(),
      ))
        ..add(NewSubUserInitialEvent()),
      child: NewSubUserScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<NewSubUserBloc, NewSubUserState>(
  ...
  /// Section Widget
  Widget _buildNewSubUser(BuildContext context) {
    return Container(
