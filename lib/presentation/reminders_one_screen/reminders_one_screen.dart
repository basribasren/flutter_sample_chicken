import 'bloc/reminders_one_bloc.dart';
import 'models/reminders_one_model.dart';
...
class RemindersOneScreen extends StatelessWidget {
  RemindersOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<RemindersOneBloc>(
      create: (context) => RemindersOneBloc(RemindersOneState(
        remindersOneModelObj: RemindersOneModel(),
      ))
        ..add(RemindersOneInitialEvent()),
      child: RemindersOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<RemindersOneBloc, RemindersOneState>(
  ...
  /// Section Widget
  Widget _buildRemindersOne(BuildContext context) {
    return Container(
