import 'bloc/new_feed_served_bloc.dart';
import 'models/new_feed_served_model.dart';
...
class NewFeedServedScreen extends StatelessWidget {
  NewFeedServedScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NewFeedServedBloc>(
      create: (context) => NewFeedServedBloc(NewFeedServedState(
        newFeedServedModelObj: NewFeedServedModel(),
      ))
        ..add(NewFeedServedInitialEvent()),
      child: NewFeedServedScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<NewFeedServedBloc, NewFeedServedState>(
