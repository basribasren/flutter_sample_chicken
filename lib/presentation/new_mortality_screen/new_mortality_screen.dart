import 'bloc/new_mortality_bloc.dart';
import 'models/new_mortality_model.dart';
...
class NewMortalityScreen extends StatelessWidget {
  NewMortalityScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<NewMortalityBloc>(
      create: (context) => NewMortalityBloc(NewMortalityState(
        newMortalityModelObj: NewMortalityModel(),
      ))
        ..add(NewMortalityInitialEvent()),
      child: NewMortalityScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<NewMortalityBloc, NewMortalityState>(
  ...
  /// Section Widget
  Widget _buildNewMortality(BuildContext context) {
    return Column(
      children: [
        Text(
          "lbl_mortality".tr,
