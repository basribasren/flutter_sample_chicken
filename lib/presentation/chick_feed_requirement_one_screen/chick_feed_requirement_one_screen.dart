import 'bloc/chick_feed_requirement_one_bloc.dart';
import 'models/chick_feed_requirement_one_model.dart';
...
class ChickFeedRequirementOneScreen extends StatelessWidget {
  ChickFeedRequirementOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<ChickFeedRequirementOneBloc>(
      create: (context) =>
          ChickFeedRequirementOneBloc(ChickFeedRequirementOneState(
        chickFeedRequirementOneModelObj: ChickFeedRequirementOneModel(),
      ))
            ..add(ChickFeedRequirementOneInitialEvent()),
      child: ChickFeedRequirementOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ChickFeedRequirementOneBloc,
        ChickFeedRequirementOneState>(
