import 'bloc/egg_tray_size_bloc.dart';
import 'models/egg_tray_size_model.dart';
...
class EggTraySizeScreen extends StatelessWidget {
  EggTraySizeScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<EggTraySizeBloc>(
      create: (context) => EggTraySizeBloc(EggTraySizeState(
        eggTraySizeModelObj: EggTraySizeModel(),
      ))
        ..add(EggTraySizeInitialEvent()),
      child: EggTraySizeScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<EggTraySizeBloc, EggTraySizeState>(
  ...
  /// Section Widget
  Widget _buildEggTraySize(BuildContext context) {
    return Container(
